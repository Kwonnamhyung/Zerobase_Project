...
<%
    ...
    wifiService.setLAT(LAT);
    wifiService.setLNT(LNT);
    wifiService.registerHistory(LAT,LNT);
    List<WIFIInfo> list = wifiService.getNearWifiInfo();
%>
<h1>와이파이 정보 구하기</h1>
<p1>
    ...
    <br>
    <strong>LAT: </strong>
    <input type="text" id = "LAT" size="15" value=<%=wifiService.getLAT()%>>
    <strong>LNT: </strong>
    <input type="text" id = "LNT" size="15" value=<%=wifiService.getLNT()%>>
...
<table id="customers">
    ...
    <tbody id = "tbody">
        ...
        %>
            <tr>
                <td><%=wifiInfo.getDistance().substring(0,6)%></td>
